#!/usr/bin/env pythonimport rospy, actionlib
import threadfrom control_msgs.msg import GripperCommandAction
from std_msgs.msg import Float64
from math import asinclass ParallelGripperActionController:
   ...
   def __init__(self):
       ...
       self.server.start()
       rospy.spin()    def actionCb(self, goal):
       ...
       rospy.loginfo('Gripper Controller: Done.')if __name__=='__main__':
   try:
